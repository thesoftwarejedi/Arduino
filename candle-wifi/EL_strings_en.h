...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h2>{v}</h2>";
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#993399;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #993399}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#993399;text-decoration:underline}"
// quality icons
...
const char S_ssidpre[]            PROGMEM = "EnderLab-Candle";
