...
boolean WiFiManager::autoConnect() {
  String ssid = _wifissidprefix + "-" + String(WIFI_getChipId(),HEX);
...
boolean  WiFiManager::startConfigPortal(char const *apName, char const *apPassword) {
  ...
  if(_apName == "") _apName = _wifissidprefix + "-" + String(WIFI_getChipId(),HEX);
...
void WiFiManager::handleRoot() {
  ...
  str.replace(FPSTR(T_v),"Ender Lab WiFi Candle Setup"); // use ip if ap is not active for heading
  page += str;
