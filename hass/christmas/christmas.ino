...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "led-cmas-lr" //change this to whatever you want to call your device
...
const char* light_state_topic = "ender/cmas-lr";
const char* light_set_topic = "ender/cmas-lr/set";
const char* light_set_topic_group = "ender/cmas-group/set";
