...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "led-cmas-doorway" //change this to whatever you want to call your device
...
const char* light_state_topic = "ender/test";
const char* light_set_topic = "ender/test/set";
