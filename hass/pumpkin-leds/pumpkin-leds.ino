...
const char* ssid = "GoodLife"; //type your WIFI information inside the quotes
const char* password = "Exodus20:15";
const char* mqtt_server = "10.0.0.200";
const char* mqtt_username = "dana";
const char* mqtt_password = "15632ftl172";
const int mqtt_port = 1883;



/**************************** FOR OTA **************************************************/
#define SENSORNAME "led-pumpkins" //change this to whatever you want to call your device
...
const char* light_state_topic = "ender/pumpkin";
const char* light_set_topic = "ender/pumpkin/set";
...
#define GOOD_LED_SIZE 12
int goodLeds[GOOD_LED_SIZE] = { 4, 5, 
                                13, 14, 15, 
                                26, 27, 28, 
                                44, 45, 46, 47 };
